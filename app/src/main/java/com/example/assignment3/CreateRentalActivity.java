...
public class CreateRentalActivity extends AppCompatActivity {
    ...
    private static final String TAG = "CreateRental";

    private EditText homestayName, homestayAddress, homestayPrice;
        ...
        if (imageUri != null) {
            ...
            fileReference.putFile(imageUri)
                    .addOnSuccessListener(taskSnapshot -> fileReference.getDownloadUrl().addOnSuccessListener(uri -> {
                        ...
                        Rental rental = new Rental(null, name, address, price, propertyType, facilities, imageUrl, latitude, longitude);
